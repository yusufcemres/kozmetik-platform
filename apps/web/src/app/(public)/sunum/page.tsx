...
const ROADMAP = [
  { period: '2026 Q2', status: 'active', items: ['Lansman canlı', 'Mobil PWA', 'Affiliate ağı (8 platform)', 'Cilt analizi quizi', 'REVELA Podcast — Spotify\'da yayında'] },
  { period: '2026 Q3', status: 'planned', items: ['IOS + Android native', 'Brand portal (B2B)', 'AI etiket okuma (foto)', 'Podcast 75+ bölüm pipeline', 'Topluluk yorumları'] },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-col items-center gap-2 text-xs text-on-surface-variant">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-on-surface">475 INCI bileşeninin tamamında</span> bilimsel kanıt derecelendirmesi (A-E) + literatür atıfı — <span className="font-semibold text-score-high">%100 kapsama</span>
            </div>
          </div>
        </div>
      </section>

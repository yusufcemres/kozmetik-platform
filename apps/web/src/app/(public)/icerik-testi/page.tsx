...
const QUESTIONS: Question[] = [
  ...
  // 2026-05-18: 8 ek soru — geniş içerik kültürü
  {
    id: 'q11',
    question: 'Squalane (skualan) hangi kaynaktan elde edilir?',
    options: [
      { value: 'a', label: 'Sadece köpek balığı karaciğeri' },
      { value: 'b', label: 'Zeytin, şeker kamışı veya köpek balığı' },
      { value: 'c', label: 'Sentetik petrol türevi' },
      { value: 'd', label: 'Hayvansal yağ' },
    ],
    correct: 'b',
    explanation: 'Skualan günümüzde çoğunlukla zeytin veya şeker kamışından üretilir. Etiketten kaynağı kontrol et — vegan ürünler bitki kaynaklı tercih eder.',
    topic: 'Aktif Maddeler',
  },
  {
    id: 'q12',
    question: 'Vitamin C + Niacinamide aynı rutinde kullanılabilir mi?',
    options: [
      { value: 'a', label: 'Hayır, niacin oluşturur' },
      { value: 'b', label: 'Evet, modern formülasyonlarda sorun yok' },
      { value: 'c', label: 'Sadece sabah birlikte' },
      { value: 'd', label: 'Sadece doktor onayıyla' },
    ],
    correct: 'b',
    explanation: 'Eski 1960\'lar verisi yanlış yorumlanmıştı. Modern stabilize formüllerde Vit C + Niacinamide güvenli ve sinerjiktir.',
    topic: 'İçerik Etkileşimleri',
  },
  {
    id: 'q13',
    question: 'Mineral filtre (Zinc Oxide, Titanium Dioxide) ile kimyasal filtre arasındaki fark?',
    options: [
      { value: 'a', label: 'Kimyasal toksik, mineral değil' },
      { value: 'b', label: 'Mineral UV\'yi yansıtır, kimyasal emer' },
      { value: 'c', label: 'Mineral daha az korur' },
      { value: 'd', label: 'Hiç fark yok' },
    ],
    correct: 'b',
    explanation: 'Mineral filtreler UV\'yi fiziksel olarak yansıtır + emer; kimyasal filtreler emip ısıya dönüştürür. Hassas cilt için mineral daha tolerans gösterir.',
    topic: 'Güneş Koruma',
  },
  {
    id: 'q14',
    question: 'Parfümsüz ürün herkese güvenli midir?',
    options: [
      { value: 'a', label: 'Evet, %100 güvenli' },
      { value: 'b', label: 'Çoğunlukla, ama esansiyel yağ alerjisi olabilir' },
      { value: 'c', label: 'Sadece çocuklarda güvenli' },
      { value: 'd', label: 'Hayır, parfümsüz tehlikeli' },
    ],
    correct: 'b',
    explanation: 'Parfümsüz formül genel olarak hassas cilde uygundur, ama esansiyel yağ türevleri (limonene, linalool) alerji yapabilir. Patch test yararlı.',
    topic: 'Güvenlik',
  },
  {
    id: 'q15',
    question: 'Hangi aktif gebelikte güvenli kabul edilmez?',
    options: [
      { value: 'a', label: 'Hyaluronik Asit' },
      { value: 'b', label: 'Retinol / Retinoidler' },
      { value: 'c', label: 'Niacinamide' },
      { value: 'd', label: 'Vitamin C' },
    ],
    correct: 'b',
    explanation: 'Retinoidler (retinol, tretinoin, adapalen) sistemik emilim riski nedeniyle gebelikte önerilmez. Yerine bakuchiol veya peptit kullanılabilir.',
    topic: 'Güvenlik',
  },
  {
    id: 'q16',
    question: 'Peptit serum ne işe yarar?',
    options: [
      { value: 'a', label: 'Cildi soyar' },
      { value: 'b', label: 'Kollajen üretimini uyarır (sinyal molekülleri)' },
      { value: 'c', label: 'Yağı çözer' },
      { value: 'd', label: 'Sadece bariyer onarır' },
    ],
    correct: 'b',
    explanation: 'Peptitler aminoasit zincirleridir; cilde "kollajen üret" sinyali verir. Anti-aging için retinole tolerans gösteremeyen ciltlere alternatif.',
    topic: 'Anti-Aging',
  },
  {
    id: 'q17',
    question: 'Cilt patch test (örnek deneme) ne zaman yapılmalı?',
    options: [
      { value: 'a', label: 'Asla, gereksiz' },
      { value: 'b', label: 'Yeni ürün kullanmadan 24-48 saat önce, kulak arkasına' },
      { value: 'c', label: 'Sadece ilaçlar için' },
      { value: 'd', label: 'Doktor onayı şart' },
    ],
    correct: 'b',
    explanation: 'Patch test (yama testi) yeni aktif veya parfümlü ürünleri kulak arkası ya da iç dirsek bölgesinde 24-48 saat dene → reaksiyon yoksa yüze uygula.',
    topic: 'Güvenlik',
  },
  {
    id: 'q18',
    question: '"Non-comedogenic" etiketi ne anlam ifade eder?',
    options: [
      { value: 'a', label: 'Anti-bakteriyel' },
      { value: 'b', label: 'Gözenek tıkamayan formül' },
      { value: 'c', label: 'SPF içerir' },
      { value: 'd', label: 'Vegan' },
    ],
    correct: 'b',
    explanation: '"Non-comedogenic" gözenek tıkayıcı bileşen içermediği iddia edilen formülasyon. Akneye yatkın ciltler için tercih edilir ama bireysel tepki değişir.',
    topic: 'Etiket Bilgisi',
  },
];

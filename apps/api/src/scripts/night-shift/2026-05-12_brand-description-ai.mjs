/**
 * Gece vardiyasi FAZ 10 — Yeni eklenen 31 marka icin description + tagline + founded_year AI.
 * Sonnet 4.5 ile her marka icin: 2-3 cumle aciklama + slogan + kurulus yili tahmini + 4 kategori.
 */
...
// Description'siz yeni markalar (son 12 saat)
